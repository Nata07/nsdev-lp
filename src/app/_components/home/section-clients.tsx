      ...
      <div className="container max-w-screen-xl gap-12 items-start">
        <div className="relative mx-auto flex w-full flex-col justify-between gap-10 px-5 md:flex-row">
          <div className="divide-y divide-gray-700">
            ...
            <img alt="Ifood, Globo, C6 Bank, NuBank e Mercado Livre" loading="lazy" width="543" height="35" decoding="async" className="mt-4 pt-4" src="/clients-home.svg" style={{ color: 'transparent' }} />
          </div>
